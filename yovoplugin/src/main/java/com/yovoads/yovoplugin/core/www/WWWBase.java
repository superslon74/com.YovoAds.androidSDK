...
public class WWWBase extends AsyncTask<String, Void, String>
{
    ...
    protected String doInBackground(String... _postParams) {
        return YBaseHttp.CreateConnect(DI._URL_QURATOR + EWwwCommand.GetValue(me_wwwComand) + "?id=" + DI.m_yovoAdsAccountId + "&token=" + DI.m_yovoAdsToken, _postParams[0], mi_yHttpConnectResult);
    }
