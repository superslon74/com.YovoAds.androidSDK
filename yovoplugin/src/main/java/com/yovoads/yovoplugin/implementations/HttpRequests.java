...
public final class HttpRequests
{
    ...
    {
        new HttpAsyncTask(_wwwCommand, m_urlCrossPromo, _iYHttpConnectResult, _adUnitType).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, _idRule);
    }
    ...
    {
        new HttpAsyncTask(_wwwCommand, m_urlExchange, _iYHttpConnectResult, _adUnitType).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, _idRule);
    }
    ...
    {
        new HttpAsyncTask(_wwwCommand, m_urlYovoAdvertising, _iYHttpConnectResult, _adUnitType).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,_idRule);
    }
}
